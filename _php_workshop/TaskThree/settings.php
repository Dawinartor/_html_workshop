...
// Website URL
$settings['website_url'] = 'http://example.com/';

// Guestbook title
$settings['gbook_title'] = "My Guestbook";

// Your e-mail address.
$settings['admin_email'] = 'me@example.com';

// URL of the gbook.php file.
$settings['gbook_url'] = 'http://example.com/gbook/gbook.php';
